...
def main(*args):
    ...
    sources = { u'Q190804' : { u'collectienaam' : u'Rijksmuseum',
                ...
                u'Q3044768' : { u'collectienaam' : u'Musée du Louvre',
                               u'replacements' : [],
                               u'pageTitle' : u'User:Multichill/Louvre RKD to match',
                               },
                u'Q154568' : { u'collectienaam' : u'Alte Pinakothek',
                                u'replacements' : [],
                                u'pageTitle' : u'User:Multichill/Alte Pinakothek RKD to match',
                                },
                u'Q848313' : { u'collectienaam' : u'Fries Museum',
                               u'replacements' : [(u'^(\d\d)$', u'S000\\1'),
                                                  ...
                                                  (u'^S (\d.+)$', u'S\\1'),
                                                  (u'^FM (\d.+)$', u'S\\1'),],
                               u'pageTitle' : u'User:Multichill/Fries Museum RKD to match',
                               },
                u'Q510324' : { u'collectienaam' : u'Philadelphia Museum of Art  - John G. Johnson Collection',
                               u'replacements' : [(u'^(\d+)$', u'Cat. \\1'),
                                                  (u'^cat\. (\d+)$', u'Cat. \\1'),],
                               u'pageTitle' : u'User:Multichill/Philadelphia Museum of Art RKD to match',
                               },
                u'Q1051928' : { u'collectienaam' : u'Kröller-Müller Museum',
                               u'replacements' : [(u'^KM([^\s]+.+)$', u'KM \\1'),],
                               u'pageTitle' : u'User:Multichill/Kröller-Müller RKD to match',
                               },
                u'Q239303' : { u'collectienaam' : u'Art Institute of Chicago, The',
                                u'replacements' : [],
                                u'pageTitle' : u'User:Multichill/Art Institute of Chicago RKD to match',
                                },
                u'Q1201549' : { u'collectienaam' : u'Detroit Institute of Arts',
                               u'replacements' : [],
                               u'pageTitle' : u'User:Multichill/Detroit Institute of Arts RKD to match',
                               },
                u'Q49133' : { u'collectienaam' : u'Museum of Fine Arts Boston',
                                u'replacements' : [],
                                u'pageTitle' : u'User:Multichill/Museum of Fine Arts Boston RKD to match',
                                },
                u'Q2365880' : { u'collectienaam' : u'Museum voor Schone Kunsten Gent',
                              u'replacements' : [],
                              u'pageTitle' : u'User:Multichill/MSK Gent RKD to match',
                              },
                u'Q12013217' : { u'collectienaam' : u'Noordbrabants Museum',
                                u'replacements' : [],
                                u'pageTitle' : u'User:Multichill/Noordbrabants Museum RKD to match',
                                },
                u'Q1459037' : { u'collectienaam' : u'Royal Collection, The',
                                 u'replacements' : [],
                                 u'pageTitle' : u'User:Multichill/Royal Collection RKD to match',
                                 },
                u'Q153306' : { u'collectienaam' : u'Muzeum Narodowe w Warszawie',
                                u'replacements' : [],
                                u'pageTitle' : u'User:Multichill/National Museum in Warsaw RKD to match',
                                },
                u'Q2051997' : { u'collectienaam' : u'Scottish National Gallery',
                               u'replacements' : [(u'^(\d+)$', u'NG \\1'),],
                               u'pageTitle' : u'User:Multichill/National Galleries of Scotland RKD to match',
                               },
                u'Q1641836' : { u'collectienaam' : u'Los Angeles County Museum of Art',
                                u'replacements' : [],
                                u'pageTitle' : u'User:Multichill/LACMA RKD to match',
                                },
                u'Q176251' : { u'collectienaam' : u'Museo Thyssen-Bornemisza',
                                u'replacements' : [],
                                u'pageTitle' : u'User:Multichill/Museo Thyssen-Bornemisza RKD to match',
                                },
               }
    collectionid = None
    autoadd = 0
