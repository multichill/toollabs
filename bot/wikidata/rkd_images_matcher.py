...
def main(*args):
    ...
    sources = { u'Q190804' : { u'collectienaam' : u'Rijksmuseum',
                ...
                u'Q812285' : { u'collectienaam' : u'Alte Pinakothek', # u'Bayerische Staatsgemäldesammlungen',
                                u'replacements' : [],
                ...
                u'Q18600731' : { u'collectienaam' : u'Dienst voor \'s Rijks Verspreide Kunstvoorwerpen', #u'Instituut Collectie Nederland', #u'Rijksdienst voor het Cultureel Erfgoed',
                                u'replacements' : [(u'^(.+)\s(.+)$', u'\\1\\2'),], # Remove the extra space
                ...
                u'Q255409' : { u'collectienaam' : u'De Mesdag Collectie',
                               u'replacements' : [],
                               u'pageTitle' : u'Wikidata:WikiProject sum of all paintings/RKD to match/Museum Mesdag',
                               },
