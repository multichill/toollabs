...
class RKDimagesMatcher:
    ...
    def process_collection(self, collection_qid, autoadd=0):
        ...
        if not self.collections.get(collection_qid):
            return
        collectienaam = self.collections.get(collection_qid).get('collectienaam')
        replacements = self.collections.get(collection_qid).get('replacements')
        reportpage = self.collections.get(collection_qid).get('reportpage')
