        ...
        for match in re.finditer(searchRegex, searchPageData):
            ...
            if mediumMatch:
                ...
                mediums = { 'oil on canvas' : 'oil on canvas',
                            ...
                            'oil on pine' : 'oil on pine panel',
                            'oil on poplar' : 'oil on poplar panel',
                            ...
                            'tempera on oak' : 'tempera on oak panel',
                            'tempera on pine' : 'tempera on pine panel',
                            'tempera on poplar' : 'tempera on poplar panel',
