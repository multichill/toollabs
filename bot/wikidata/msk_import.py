...
def getMSKGenerator():
    ...
    # Open the types
    # Op 15 januari 2016 de juiste versie er neergezet
    ...
    with open('MSK_import_wikidata_objects_16112015.csv', 'rb') as csvfile:
        ...
        for row in reader:
            ...
            metadata['collectionqid'] = u'Q2365880'
            metadata['collectionshort'] = u'MSK Gent'
            metadata['locationqid'] = u'Q2365880'
