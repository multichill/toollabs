...
class GroeningeBot:
    ...
    def run (self):
        ...
        with open('CVG-creators-completed.csv', 'wb') as csvfile:
    ...
    def makeCreatorItem(self, name, rkd, viaf):
        ...
        identification = {}
        summary = u'Creating new item for CVG artist'
...
def getPainterGenerator():
    with open('CVG-creators-completed-2016-01-23.csv', 'rb') as csvfile:    
