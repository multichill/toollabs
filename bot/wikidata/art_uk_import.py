...
def get_art_uk_generator(start_year, start_search_page, venue=None, collection=None, only_new=None):
    """
...
def main(*args):
    ...
    painting_generator = get_art_uk_generator(start_year, start_search_page, art_uk_venue, art_uk_collection, only_new)
