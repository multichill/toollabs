...
def getPaintingGenerator(query=u''):
    ...
    * Grab data from paintings
    ...
    baseurl = u'http://www.mfa.org/collections/search?search_api_views_fulltext=&sort=search_api_aggregation_1&order=asc&f[0]=field_classifications%%3A16&f[1]=field_collections%%3A4&page=%s' 
...
def main():
    ...
    paintingsBot = PaintingsBot(paintingGen, 217, u'49133')
    paintingsBot.run()
