...
class BPNFinderBot:
    ...
    """
    def __init__(self, generator, otherproperty, idregex):
        """
        Arguments:
        ...
        # Does not have BGP, but does have the other property
    ...
    def getOtherPropertyId(self, bpnid):
        ...
        bpnurl = u'http://www.biografischportaal.nl/persoon/%s?' % (bpnid,)
...
def biografischportaalGenerator(source_id):
    ...
    step = 30
    for i in range(300, total+step, step):
