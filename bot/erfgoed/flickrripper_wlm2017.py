...
This is a hacked up version for WLM2017 based on the generic one.
...
def processPhoto(flickr, photo_id, flickrreview=False, reviewer=u'',
                 override=u'', addCategory=u'', removeCategories=False,
                 autonomous=False):
    ...
    if isAllowedLicense(photoInfo) or override:
        ...
        if duplicates:
            ...
            for tag in tags:
                photoDescription = photoDescription + u'[[Category:' + tag + ']]\n'
...
def getPhotos(flickr):
    #, user_id=u'', group_id=u'', photoset_id=u'',
    #          start_id='', end_id='', tags=u''):
    """Loop over a set of Flickr photos."""
    photos = flickr.photos.search(min_upload_date= '2017-08-31',
                                  max_upload_date = '2017-09-30',
                                  license= '4,5,9',
                                  group_id ='2581696@N23',
                                  format = u'json',
                                  page = u'2')
    parsed = json.loads(photos.decode('utf-8'))


    #photos = flickr.walk(group_id = u'2581696@N23',
    #                         min_upload_date= '2017-08-31',
    #                     max_upload_date = '2017-09-30',
    #                     license= '4,5,9',
    #                     per_page=25)
                         #group_id ='2581696@N23')
    #photos = flickr.get(u'flickr.photos.search', params = { u'min_upload_date' : '2017-08-31',}
#                                   u'max_upload_date' : '2017-09-30',
#                                   u'license' : '4|5|9',
#                                   u'group_id' : '2581696@N23'}
#                        )
    #print parsed
    #print photos.dump()
    for photo in parsed.get('photos').get('photo'):
        print photo
        print photo.get('id')
        #print photo.get('license')
...
def main(*args):
    ...
    """
    for photo_id in getPhotos(flickr):
